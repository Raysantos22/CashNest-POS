...
data class Product(
    ...
    // NEW PRICE FIELDS
    @ColumnInfo(name = "mallprice") val mallprice: Double = 0.0,
    @ColumnInfo(name = "grabfoodmall") val grabfoodmall: Double = 0.0,
    @ColumnInfo(name = "foodpandamall") val foodpandamall: Double = 0.0
)
