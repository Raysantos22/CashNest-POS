...
data class TransactionSummary(
    ...
    // CHANGED: Date -> String to avoid conversion issues
    ...
    @ColumnInfo(name = "vatAmount") val vatAmount: Double,
    @ColumnInfo(name = "vatExemptAmount") val vatExemptAmount: Double,
    @ColumnInfo(name = "vatableSales") val vatableSales: Double,
    ...
    @ColumnInfo(name = "store_key") var storeKey: String,
